...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=Cycling&apiKey=${API_KEY}`;
...
//             <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Boxing News</h1>
