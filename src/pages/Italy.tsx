...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=Italy&apiKey=${API_KEY}`;

// const Italy = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch Italy News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Italy News</h1>
