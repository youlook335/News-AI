...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=Australia&apiKey=${API_KEY}`;

// const Australia = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch Australia News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Australia News</h1>
