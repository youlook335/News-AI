...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=France&apiKey=${API_KEY}`;

// const France = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch France News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">France News</h1>
