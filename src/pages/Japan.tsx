...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=Japan&apiKey=${API_KEY}`;

// const Japan = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch Japan News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Japan News</h1>
