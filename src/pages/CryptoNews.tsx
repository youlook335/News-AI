...
//       <h2 className="text-3xl font-bold mb-6 text-purple-800 text-center"> Cryptocurrency News</h2>
...
//               className="text-purple-700 font-semibold mt-3 inline-block"
//             >
//               Read More →
//             </a>
//           </div>
