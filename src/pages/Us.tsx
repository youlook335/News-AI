...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=Us&apiKey=${API_KEY}`;
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">United States News</h1>
