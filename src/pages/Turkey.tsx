...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=Turkey&apiKey=${API_KEY}`;

// const Turkey = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch Turkey News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Turkey News</h1>
