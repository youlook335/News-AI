...
//       try {
//         const NEWS_URL = `https://newsapi.org/v2/everything?q=banking&apiKey=${API_KEY}`;
//         const response = await fetch(NEWS_URL); // ✅ fetch استعمال کیا
...
//       <h2 className="text-3xl font-bold mb-6 text-blue-800 text-center">Banking News</h2>
