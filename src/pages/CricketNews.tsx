...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=cricket&apiKey=${API_KEY}`;

// const CricketNews = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch Cricket News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Cricket News</h1>
