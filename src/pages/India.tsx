...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=india&apiKey=${API_KEY}`;

// const India = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch India News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">India News</h1>
