...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=pakistan&apiKey=${API_KEY}`;

// const Pakistan = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch Pakistan News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Pakistan News</h1>
