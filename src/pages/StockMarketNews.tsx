...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=stockmarket&apiKey=${API_KEY}`;
...
//         setNews(data.articles.slice(0, 200));
//       } catch (error) {
...
//       <h2 className="text-3xl font-bold mb-6 text-green-800 text-center">Stock Market News</h2>
