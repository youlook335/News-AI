...
// const NEWS_URL = `https://newsapi.org/v2/everything?q=Canada&apiKey=${API_KEY}`;

// const Canada = () => {
//   const [news, setNews] = useState([]);

//   // 🏏 Fetch Canada News API
//   useEffect(() => {
...
//       <h1 className="text-4xl text-center font-bold mb-6 text-blue-900">Canada News</h1>
